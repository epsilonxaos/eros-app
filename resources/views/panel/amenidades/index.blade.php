...
@section('content')
					...
					<div class="table-responsive pb-3">
						<table class="table align-items-center table-flush" id="dataTable">
							<thead class="thead-light">
								<tr>
									<th scope="col" class="sort" data-sort="icono">Icono</th>
                                    ...
                                    @foreach ($lista as $num => $row)
                                        <tr>
                                            <td style="width: 120px">
                                                <div class="bg" style="background-image: url({{asset($row -> img)}})"> </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center" width="200px">
                                                ...
                                                {{-- @can(PermissionKey::Noticias['permissions']['edit']['name'])
                                                @endcan --}}
                                                <form action="{{route('panel.eros.amenidades.destroy', ['id' => $row -> id])}}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal" tabindex="-1" role="dialog" id="mdAdd">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('panel.eros.amenidades.store')}}" method="post" enctype="multipart/form-data" class="form-submit-alert-wait">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
                        <h5 class="modal-title">Agregar nueva amenidad</h5>
                    ...
                    <div class="modal-body pt-0">
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                <label for="img">Icono <span class="text-danger">*</span></label>
                                <input type="file" name="img" class="dropify" data-height="300" required data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png" />
                                <small>Las medidas recomendadas son 670 x 396 px, solo se aceptan .jpg, .jpeg y .png con un maximo de peso de 2MB.</small>
                                @if($errors -> has('img'))
                                    <br>
                                    <small class="text-danger pt-1">{{ $errors -> first('img') }}</small>
                                @endif
                            </div>
                            <div class="col-12 mb-4">
    ...
    <div class="modal" tabindex="-1" role="dialog" id="mdEdit">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('panel.eros.amenidades.update')}}" method="post" enctype="multipart/form-data" class="form-submit-alert-wait">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body pt-0">
                        ...
                        <p>Haga clic en el cuadro para subir el nuevo icono para reemplazar desde el ordenador o si lo prefiere puede arrastrar y soltar en el cuadro:</p>
                        <div class="row">
                            <div class="col-12 mb-4">
                            ...
                            <div class="col-12 mb-4">
                                <label for="titulo">Titulo <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="titulo" id="tituloE" requied />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        function mdEdit(idx) {
            ...
            let input = document.createElement('input');
                ...
                input.setAttribute('data-default-file', PATH + index['img']);
