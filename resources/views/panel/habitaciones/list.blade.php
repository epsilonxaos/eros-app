                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="wp">
                                                    ...
                                                    <label class="tgl-btn toggle_{{$num}}" for="toggle_{{$num}}" onclick="changeStatusGeneral('toggle_{{$num}}', {{$row -> id}}, {{($row -> status == 1) ? 0 : 1}}, '{{route('panel.eros.productos.status')}}')"></label>
                                                </div>
