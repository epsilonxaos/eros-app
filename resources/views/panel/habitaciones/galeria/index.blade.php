                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-sm-6 text-center text-sm-right">
                                    @if ($accion === 'edit')
                                        <a href="{{route('panel.eros.habitaciones.index')}}" class="btn btn-primary pt-2 pb-2"><i class="fas fa-save mr-2"></i> Guardar y regresar</a>
                                    @else
                                        <a href="{{route('panel.eros.habitaciones.create')}}" class="btn btn-primary pt-2 pb-2"><i class="fas fa-save mr-2"></i> Guardar y finalizar</a>
                                    @endif
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <form action="{{route('panel.eros.productos.galeria.store')}}" method="POST" enctype="multipart/form-data" id="my-dropzone" class="dropzone mt-3" style="border: 2px dashed #d6d6d6;">
                                            @csrf
                                        ...
                                        <div class="text-center pt-3">
                                            @if ($accion === 'edit')
                                                <a href="{{route('panel.eros.habitaciones.galeria.acciones', ['accion' => 'edit', 'id' => $id])}}" class="btn btn-default"><i class="fas fa-save mr-2"></i> Guardar imágenes</a>
                                            @else
                                                <a href="{{route('panel.eros.habitaciones.galeria.acciones', ['accion' => 'create', 'id' => $id])}}" class="btn btn-default"><i class="fas fa-save mr-2"></i> Guardar imágenes</a>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-12"> <hr> </div>
                                    <div class="col-12">
                                        <div class="row" id="sortable-items" data-url="{{route('panel.eros.productos.galeria.ordenamiento')}}">
                                            @if (count($galeria) > 0)
                                                @foreach ($galeria as $item)
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-3 position-relative sort px-2" data-orden="{{$item -> order}}" data-idx="{{$item -> id}}">
                                                        <div class="options-flotting d-flex align-items-center justify-content-end pr-3">
                                                            ...
                                                            <div class="item delete delete-axios" data-url="{{route('panel.eros.productos.galeria.destroy')}}" data-idx="{{$item -> id}}" title="Eliminar"><i class="fas fa-trash fa-lg text-white"></i></div>
                                                        </div>
