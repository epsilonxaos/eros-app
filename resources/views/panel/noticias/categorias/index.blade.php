...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="200px">
                                                ...
                                                @can(PermissionKey::Noticias['permissions']['destroy']['name'])
                                                    <form action="{{route('panel.noticias.categorias.destroy', ['id' => $row -> id])}}" method="post" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal" tabindex="-1" role="dialog" id="mdAdd">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('panel.noticias.categorias.store')}}" method="post" enctype="multipart/form-data" class="form-submit-alert-wait">
                    @csrf
                    @method('PUT')
    ...
    <div class="modal" tabindex="-1" role="dialog" id="mdEdit">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('panel.noticias.categorias.update')}}" method="post" enctype="multipart/form-data" class="form-submit-alert-wait">
                    @csrf
                    <div class="modal-header">
