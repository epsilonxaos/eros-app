                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-12 col-sm-6"><h3>Editar noticia - <span class="text-primary">{{$noticias -> titulo}}</h3></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_categoria">
                                                ...
                                                @foreach ($categorias as $item)
                                                    <option {{$noticia -> noticias_categorias_id == $item -> id ? 'selected' : ''}} value="{{$item -> id}}">{{$item -> titulo}}</option>
                                                @endforeach
                                            </select>
