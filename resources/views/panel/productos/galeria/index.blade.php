                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-sm-6 text-center text-sm-right">
                                    @if ($accion === 'edit')
                                        <a href="{{route('panel.eros.productos.index')}}" class="btn btn-primary pt-2 pb-2"><i class="fas fa-save mr-2"></i> Guardar y regresar</a>
                                    @else
                                        <a href="{{route('panel.eros.productos.create')}}" class="btn btn-primary pt-2 pb-2"><i class="fas fa-save mr-2"></i> Guardar y finalizar</a>
                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="text-center pt-3">
                                            @if ($accion === 'edit')
                                                <a href="{{route('panel.eros.productos.galeria.acciones', ['accion' => 'edit', 'id' => $id])}}" class="btn btn-default"><i class="fas fa-save mr-2"></i> Guardar imágenes</a>
                                            @else
                                                <a href="{{route('panel.eros.productos.galeria.acciones', ['accion' => 'create', 'id' => $id])}}" class="btn btn-default"><i class="fas fa-save mr-2"></i> Guardar imágenes</a>
                                            @endif
                                        </div>
                                    </div>
